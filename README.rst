...
>This  `article <https://github.com/settings/tokens>`__ might help you create an environment variable in a Unix-based operational system with Bash, but feel free >to search alternatives for other systems and shells.
